<?php
class partial_Header_All_5fe7661b4415d50c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
'positionClass' => $renderingContext->getViewHelperInvoker()->invoke(TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::class, $arguments12, $renderingContext)
,
...
'layout' => $renderingContext->getVariableProvider()->getByPath('data.header_layout'),
'positionClass' => $renderingContext->getViewHelperInvoker()->invoke(TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::class, $arguments19, $renderingContext)
,
'default' => $renderingContext->getVariableProvider()->getByPath('settings.defaultHeaderType'),
];
...
$output8 .= $renderingContext->getViewHelperInvoker()->invoke(TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::class, $arguments16, $renderingContext, $renderChildrenClosure17);
...
'positionClass' => $renderingContext->getViewHelperInvoker()->invoke(TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::class, $arguments26, $renderingContext)
,
];
...
$output8 .= $renderingContext->getViewHelperInvoker()->invoke(TYPO3\CMS\Fluid\ViewHelpers\RenderViewHelper::class, $arguments23, $renderingContext, $renderChildrenClosure24);
